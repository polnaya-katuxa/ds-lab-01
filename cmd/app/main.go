...
import (
	...
	openapiGenerated "github.com/polnaya-katuxa/ds-lab-01/internal/generated/openapi"
	"github.com/polnaya-katuxa/ds-lab-01/internal/logic"
	"github.com/polnaya-katuxa/ds-lab-01/internal/openapi"
	personPostgres "github.com/polnaya-katuxa/ds-lab-01/internal/repository/postgres"
...
func run() error {
	...
	personRepository := personPostgres.New(db)
	personLogic := logic.New(personRepository, logger)

	e := echo.New()
	server := openapi.New(personLogic)
